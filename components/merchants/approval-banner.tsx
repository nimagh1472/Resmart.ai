  ...
  if (profile.status === "suspended") {
    return (
      ...
      >
        ...
        />
        <div>
          <h2 className="font-heading text-sm font-semibold text-rose-700">
            Account suspended
          </h2>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        <h2 className="font-heading text-sm font-semibold text-amber-700">
          Pending Admin Approval
        </h2>
        <p className="mt-1 text-sm leading-relaxed text-amber-700/75">
        ...
        <p className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 font-mono text-[11px] uppercase tracking-wider text-amber-700/60">
          <span>Submitted {formatDate(profile.submittedOn)}</span>
          <span>Typical review · {profile.reviewEtaHours}h</span>
        </p>
      </div>

      <span className="inline-flex w-fit shrink-0 items-center gap-1.5 rounded-full border border-amber-400/30 bg-amber-400/10 px-2.5 py-1 font-mono text-[10px] uppercase tracking-widest text-amber-700">
